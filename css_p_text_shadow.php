...
<!-- start -->
<p><em>text-shadow</em> 可用來設定文字的陰影效果，嚴格說起來它不算是 CSS3 新增的屬性，早在 CSS2 屬性名單中就已經出現其名，只是遭到棄用，直至 CSS3 才正式被提出使用。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>text-shadow</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">無陰影【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">hoff</span>
        <span class="t-flex5">陰影的水平位置數值，可為負值</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">voff</span>
        <span class="t-flex5">陰影的垂直位置數值，可為負值</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">blur</span>
        <span class="t-flex5">陰影的模糊程度</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">color</span>
        <span class="t-flex5">陰影的顏色</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="mNKVbz" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-text-shadow">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/mNKVbz/">
    css-text-shadow</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.textShadow="2px 2px 4px #000"</code></pre>
