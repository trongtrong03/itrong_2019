...
<!-- start -->
<p><em>resize</em> 是 CSS3 新增的屬性，可讓使用者自行拖曳調整對象元素的大小，效果類似 <em>&lt;textarea&gt;</em> 元素右下角的拖曳功能。</p>
<p>需要注意的是，必須加上 <em>overflow: auto;</em> 才有效用。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>resize</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">使用者無法調整元素寬度與高度【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">both</span>
        <span class="t-flex5">使用者可調整元素寬度與高度</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">horizontal</span>
        <span class="t-flex5">使用者可調整元素寬度</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">vertical</span>
        <span class="t-flex5">使用者可調整元素高度</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="XNgdvp" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-resize">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/XNgdvp/">
    CSS-resize</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.resize="both"</code></pre>
