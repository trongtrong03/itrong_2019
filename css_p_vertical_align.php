...
<!-- start -->
<p><em>vertical-align</em> 用來設定元素的垂直對齊位置。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>vertical-align</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        <span class="t-flex1">baseline</span>
        <span class="t-flex5">基準線【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">sub / super</span>
        <span class="t-flex5">段落文字的上標 / 下標</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">top / middle / bottom</span>
        <span class="t-flex5">上 / 中/ 下</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">text-top / text-bottom</span>
        <span class="t-flex5">段落文字的上 / 下</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="JbJZMb" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-vertical-align">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/JbJZMb/">
    CSS-vertical-align</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.verticalAlign="middle"</code></pre>
