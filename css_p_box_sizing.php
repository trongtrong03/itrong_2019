...
<!-- start -->
<p><em>box-sizing</em> 是 CSS3
    規範裡才被明確定義出來的屬性，過往撰寫區塊元素寬度，內距（<em>padding</em>）和邊框（<em>border</em>）的佔據寬度是額外疊加上去的，在寬度計算上必須多做考量。
</p>
<p>預設值是 <em>content-box</em>，即該區塊的寬度值不包含內距與邊框寬度，<em>border-box</em> 則包含這兩者佔據的寬度。</p>
...
<h3 class="ex"></h3>
<div class="code-area">
    <pre id="area02" class="code-text"><code class="css">* {
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>box-sizing</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">元素寬度不包含內距與邊框【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">border-box</span>
        <span class="t-flex5">元素寬度包含內距與邊框</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="mOwKdm" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-box-sizing">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/mOwKdm/">
    CSS-box-sizing</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.boxSizing="border-box"</code></pre>
