...
<!-- start -->
<p><em>min-width</em> 主要用來設置元素的最小寬度，如果元素 <em>width</em> 值小於 <em>min-width</em>值，則會以後者設定的值作為元素寬度的基準。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>min-width</em></h2>
<div class="t-form">
    <div class="t-head">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="oKaodN" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-min-width">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/oKaodN/">
    css-min-width</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.minWidth="10rem"</code></pre>
