...
<!-- start -->
<p><em>background-attachment</em> 可用來設定背景影像在元素捲動時的定位位置。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>background-attachment</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">隨元素捲動一起移動【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">fixed</span>
        <span class="t-flex5">即使元素捲動也不會跟著移動</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="rXqQRP" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-background-attachment">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/rXqQRP/">
    css-background-attachment</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.backgroundAttachment="fixed"</code></pre>
