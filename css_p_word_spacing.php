...
<!-- start -->
<p><em>word-spacing</em> 用來設定單字與單字之間的間隔距離，至於中文字則以插入的空白字元符為一字詞判定。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>word-spacing</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">標準間隔【預設值】</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="jgpPYG" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-word-spacing">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/jgpPYG/">
    css-word-spacing</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.wordSpacing="1rem"</code></pre>
