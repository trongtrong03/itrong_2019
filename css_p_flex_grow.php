...
<!-- start -->
<p><em>flex-grow</em> 用來設定 Flexbox 內子元素的擴張倍率，本屬性會根據剩餘空間，分配給定數字的等寬比例值。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>flex-grow</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">不擴張【預設值】</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code class="mb-0">
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="RwbGJYb" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-flex-grow">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/RwbGJYb/">
    css-flex-grow</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
    on <a href="https://codepen.io">CodePen</a>.</span>
    </p>
</code>
<p>在上例中，第一和第二個設置 <em>flex-grow</em> 屬性的 <em>&lt;span&gt;</em> 元素，會在扣除第三個 <em>&lt;span&gt;</em> 賦予的 <em>width: 30px</em> 之剩餘空間裡做比例分配（3 : 1）。</p>
<br>
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.flexGrow="3"</code></pre>
