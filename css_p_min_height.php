...
<!-- start -->
<p><em>min-height</em> 主要用來設置元素的最小高度，如果元素 <em>height</em> 值小於 <em>min-height</em>值，則會以後者設定的值作為元素高度的基準。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>min-height</em></h2>
<div class="t-form">
    <div class="t-head">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="YmJEBq" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-min-height">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/YmJEBq/">
    css-min-height</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.minHeight="10rem"</code></pre>
