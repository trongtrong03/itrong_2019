...
<!-- start -->
<p><em>text-transform</em> 用來設定文字的大小寫（例如英文）。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>text-transform</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        <span class="t-flex1">capitalize</span>
        <span class="t-flex5">每個單字的字首大寫</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">uppercase</span>
        <span class="t-flex5">全部大寫</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">lowercase</span>
        <span class="t-flex5">全部小寫</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="rXKWwq" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-text-transform">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/rXKWwq/">
    css-text-transform</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.textTransform="capitalize"</code></pre>
