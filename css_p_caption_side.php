...
<!-- start -->
<p><em>caption-side</em> 用來設定表格標題（<em>&lt;caption&gt;</em>）的顯示位置。</p>
...
<h3 class="ex"></h3>
<div class="code-area">
<pre id="area02" class="code-text"><code class="css">caption {
    caption-side: bottom;
}</code></pre>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>caption-side</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        <span class="t-flex1">top</span>
        <span class="t-flex5">表格標題定位在表格之上【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">bottom</span>
        <span class="t-flex5">表格標題定位在表格之下</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="zYOqXEd" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-caption-side">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/zYOqXEd/">
    css-caption-side</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area04" class="code-text"><code class="js">object.style.captionSide="bottom"</code></pre>
