...
<!-- start -->
<p><em>align-self</em> 用來設定 Flexbox 內單一子元素的垂直方向對齊方式。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>align-self</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">元素繼承父元素的 <em>align-items</em> 屬性，如果沒有父元素則為 <em>stretch</em>【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">stretch</span>
        <span class="t-flex5">項目延伸至容器高度</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="ZBJwod" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-flexbox-align-self">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/ZBJwod/">
    CSS-flexbox-align-self</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.alignSelf ="center"</code></pre>
