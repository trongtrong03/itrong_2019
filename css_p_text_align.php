...
<!-- start -->
<p><em>text-align</em> 可用來設定對象元素內文字的對齊方式。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>text-align</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">水平靠左對齊【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">right</span>
        <span class="t-flex5">水平靠右對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">center</span>
        <span class="t-flex5">水平置中對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">justify</span>
        <span class="t-flex5">往左右兩側分散對齊</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="MNGgWX" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-text-align">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/MNGgWX/">
    css-text-align</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
    on <a href="https://codepen.io">CodePen</a>.</span>
    </p>
</code>

<p><em>text-align</em> 與 <em>direction</em> 屬性都可以對元素內文本、並排元素設定排列方向的操作，有關兩者的差異，可見此篇：<a href="css_t_direction_vs_text_align.php" target="_blank">〈direction V.S. text-align〉</a>。</p>

<!-- JS調用 -->
<h2 class="cssjs"></h2>
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.textAlign="center"</code></pre>
