...
<!-- start -->
<p><em>background-origin</em> 可用來設定背景影像的定位基準點。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>background-origin</em></h2>
<div class="t-form mb-0">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">背景影像相對於元素內距來定位【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">border-box</span>
        <span class="t-flex5">背景影像相對於元素邊框來定位</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">content-box</span>
        <span class="t-flex5">背景影像相對於元素內容來定位</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="rXqPPG" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-background-origin">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/rXqPPG/">
    css-background-origin</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.backgroundOrigin="padding-box"</code></pre>
