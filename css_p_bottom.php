...
<!-- start -->
<p><em>bottom</em> 用來設定該元素距離父元素下方的偏移位置。切記，此屬性需同時存在 <em>position</em> 屬性且其參數值不是 <em>static</em> 才有效果。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>bottom</em></h2>
<div class="t-form">
    <div class="t-head"> 
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="dybYRQq" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-bottom">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/dybYRQq/">
    css-bottom</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
    on <a href="https://codepen.io">CodePen</a>.</span>
    </p>
</code>

<p>以下針對 <em>bottom</em> 之於 <em>position</em> 各參數值做一份整理簡表：</p>
<div class="t-form">
    <div class="t-head"> 
        <span class="t-flex1">Position</span>
        <span class="t-flex5">Bottom</span>
    </div>
    <div class="t-row">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">以元素本身的下緣做偏移起點</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">absolute</span>
        <span class="t-flex5">以有設置定位的父元素下緣做偏移起點</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">fixed</span>
        <span class="t-flex5">以瀏覽器窗口下緣做偏移起點</span>
    </div>
    <div class="t-row">
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.bottom="20px"</code></pre>
