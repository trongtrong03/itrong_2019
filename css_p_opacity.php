...
<!-- start -->
<p><em>opacity</em> 是 CSS3 新增的屬性，用來設定元素的不透明度，其參數值由 0.0 到 1.0，0 為完全透明，1 為不透明。</p>

<h3 class="rule"></h3>
<div class="code-area">
<pre id="area01" class="code-text"><code class="css">selector {
    opacity: value;
    filter: Alpha(opacity=Value);    /* IE8 或更早版本的寫法 */
}</code></pre>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>opacity</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        <span class="t-flex1">0.0 ~ 1.0</span>
        <span class="t-flex5">越靠近 1 越不透明【1.0 為預設值】</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="vyZYLQ" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-opacity">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/vyZYLQ/">
    CSS-opacity</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.opacity=0.5</code></pre>
