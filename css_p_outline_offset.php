...
<!-- start -->
<p><em>outline-offset</em> 用來設定該元素的 <em>outline</em> 輪廓要距離元素邊緣多少距離才繪製出來。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>outline-offset</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">無距離【預設值】</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="LbXwXg" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-outline-offset">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/LbXwXg/">
    CSS-outline-offset</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.outlineOffset="20px"</code></pre>
