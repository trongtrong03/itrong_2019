...
<!-- start -->
<p><em>background-clip</em> 可用來設定背景繪製的範圍。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>background-clip</em></h2>
<div class="t-form mb-0">
    ...
    <div class="t-row">
        <span class="t-flex1">border-box</span>
        <span class="t-flex5">背景被剪裁至邊框【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">padding-box</span>
        <span class="t-flex5">背景被剪裁至內距</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">content-box</span>
        <span class="t-flex5">背景被剪裁至內容</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">text</span>
        <span class="t-flex5">背景被剪裁至文字</span>
    </div>
    <div class="t-row">
...
<p><em>background-clip: text</em> 需要同時將文字顏色設為透明（<em>color: transperant</em>）才有效用，然而，目前本參數並沒有得到各家瀏覽器的支援，僅 -Webkit 提供替代方案，完整書寫語法為：</p>
<h3 class="ex"></h3>
<div class="code-area">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="XvxoGd" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-background-clip">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/XvxoGd/">
    css-background-clip</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area04" class="code-text"><code class="js">object.style.backgroundClip="border-box"</code></pre>
