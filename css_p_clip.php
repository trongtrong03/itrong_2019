...
<!-- start -->
<p><em>clip</em> 可用來剪裁「絕對定位」（<em>position: absolute</em>）狀態中的元素內容。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>clip</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">不剪裁【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">shape</span>
        <span class="t-flex5">公式：rect(top, right, bottom, left)</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="woeWQG" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-clip">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/woeWQG/">
    CSS-clip</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.clip="rect(0px, 50px, 50px, 0px)"</code></pre>
