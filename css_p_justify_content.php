...
<!-- start -->
<p><em>justify-content</em> 用來設定 Flexbox 內所有子元素的水平方向對齊方式。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>justify-content</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">項目置左【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">flex-end</span>
        <span class="t-flex5">項目置右</span>
    </div>
    <div class="t-row">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">分散對齊左與右</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">space-around</span>
        <span class="t-flex5">平均分散且左右留有空白</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">baseline</span>
        <span class="t-flex5">對齊於容器的基線上</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="oYeJdr" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-flexbox-justify-content">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/oYeJdr/">
    CSS-flexbox-justify-content</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.justifyContent="space-between"</code></pre>
