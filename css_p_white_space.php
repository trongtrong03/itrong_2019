...
<!-- start -->
<p><em>white-space</em> 可用來處理文本的空白字元符，這裡提到的空白字元包含 Tab 鍵與跳行（Enter），依據特定屬性值的設定，可令空白字元後的長單字接觸元素末端時挪移至下一行，產生句讀換行的效果。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>white-space</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">連續空白字元符縮減為一個 / 跳行字符視為空白 / 長字詞會跳行 【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">pre</span>
        <span class="t-flex5">連續空白字元符全保留 / 跳行字符會跳行 / 長字詞不會跳行</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">nowrap</span>
        <span class="t-flex5">連續空白字元符縮減為一個 / 跳行字符視為空白 / 長字詞不會跳行</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">pre-wrap</span>
        <span class="t-flex5">連續空白字元符全保留 / 跳行字符會跳行 / 長字詞會跳行</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">pre-line</span>
        <span class="t-flex5">連續空白字元符縮減為一個 / 跳行字符會跳行 / 長字詞會跳行</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="OKEeOv" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-white-space">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/OKEeOv/">
    css-white-space</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.whiteSpace="nowrap"</code></pre>
