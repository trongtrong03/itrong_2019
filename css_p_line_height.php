...
<!-- start -->
<p><em>line-height</em> 可用來設定對象元素內文字的行高。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>line-height</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">文字大小 x 1.2【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">number</span>
        <span class="t-flex5">設定之數字與文字大小相乘</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">length</span>
        <span class="t-flex5">依據數值單位設置固定行距</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">%</span>
        <span class="t-flex5">設定之百分比與文字大小相乘</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="XvEvxB" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-line-height">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/XvEvxB/">
    css-line-height</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.lineHeight="2"</code></pre>
