...
<!-- start -->
<p><em>border-spacing</em> 用來設定表格每一個單元格邊框之間的距離。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>border-spacing</em></h2>
...
<p>如果 <em>border-spacing</em> 給予兩個參數值，第一個值代表水平間距，第二個值代表垂直間距，例如：</p>
<h3 class="ex"></h3>
<div class="code-area">
<pre id="area03" class="code-text"><code class="css">table {
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="YzKqMPa" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-border-spacing">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/YzKqMPa/">
    css-border-spacing</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area04" class="code-text"><code class="js">object.style.borderSpacing="4px"</code></pre>
