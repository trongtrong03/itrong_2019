...
<!-- start -->
<p><em>overflow</em> 用來處理內容溢出元素時的顯示狀態。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>overflow</em></h2>
<div class="t-form">
    <div class="t-head">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="qBWbJBw" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-overflow">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/qBWbJBw/">
    css-overflow</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.overflow="hidden"</code></pre>
