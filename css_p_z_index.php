...
<!-- start -->
<p><em>z-index</em> 用來設定元素的堆疊順序，謹記，此屬性需同時存在 <em>position</em> 屬性才有效果。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>z-index</em></h2>
<div class="t-form mb-0">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">與父元素相等【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">number</span>
        <span class="t-flex5">整數，正負皆可</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="XvwQMM" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-z-index">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/XvwQMM/">
    css-z-index</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.zIndex="1"</code></pre>
