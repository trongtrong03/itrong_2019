...
<!-- start -->
<p><em>text-align-last</em> 是 CSS3 的新增屬性，用來設定文本最後一行的對齊方向。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>text-align-last</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">不改變文本【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">left</span>
        <span class="t-flex5">最後一行靠左對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">right</span>
        <span class="t-flex5">最後一行靠右對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">center</span>
        <span class="t-flex5">最後一行置中對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">justify</span>
        <span class="t-flex5">最後一行分散兩端對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">start</span>
        <span class="t-flex5">最後一行在行開頭對齊</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">end</span>
        <span class="t-flex5">最後一行在行末端對齊</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="EqRWrL" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-text-align-last">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/EqRWrL/">
    css-text-align-last</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.textAlignLast="right"</code></pre>
