...
<!-- start -->
<p><em>word-break</em> 是 CSS3 新增的屬性，用來設定文本換行的規則。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>word-break</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">遵守瀏覽器的換行規則【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">break-all</span>
        <span class="t-flex5">長字串會換行</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">keep-all</span>
        <span class="t-flex5">只能在半形空白字元與連字符間換行</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="XvBdgY" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-word-break">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/XvBdgY/">
    css-word-break</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.wordBreak="break-all"</code></pre>
...
<p>有關 <em>word-break</em> 與 <em>word-wrap</em> 的差別，可見<a href="css_t_word_break_vs_word_wrap.php" target="_blank">〈word-break V.S. word-wrap〉</a> 一文。</p>
<!-- end -->
                </div>
            </section>
        </main>
