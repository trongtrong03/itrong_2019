...
<!-- start -->
<p><em>empty-cells</em> 用來設定表格內空白單元格（<em>&lt;td&gt;</em>）的顯示方式。</p>
<p>需注意，此屬性必須以 <em>border-collapse</em> 為 <em>separate</em> 條件下（即邊框分離）才有效果。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>empty-cells</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        <span class="t-flex1">show</span>
        <span class="t-flex5">顯示【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">hidden</span>
        <span class="t-flex5">隱藏</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="MWgyRMv" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-empty-cells">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/MWgyRMv/">
    css-empty-cells</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.emptyCells="hide"</code></pre>
