...
<!-- start -->
<p><em>order</em> 用來處理 Flexbox 內子元素的排列順序。</p>
<h3 class="rule"></h3>
<div class="code-area">
...
<p>須注意本屬性必須在父元素為 <em>display: flex;</em> 下才有作用。</p>

<!-- 屬性值 -->
<h2 class="cssproperty"><em>order</em></h2>
<div class="t-form">
    <div class="t-head">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="KNvbZv" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="CSS-flexbox-order">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/KNvbZv/">
    CSS-flexbox-order</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.order="3"</code></pre>
