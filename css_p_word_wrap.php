...
<!-- start -->
<p><em>word-wrap</em> 是 CSS3 新增的屬性，用來設定文本中的長單字換行規則。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>word-wrap</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        <span class="t-flex1">break-word</span>
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="XvBdgY" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-word-wrap">
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.wordWrap="break-word"</code></pre>
