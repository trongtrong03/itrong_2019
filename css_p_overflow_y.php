...
<!-- start -->
<p><em>overflow-y</em> 用來處理內容垂直方向溢出元素時的顯示狀態。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>overflow-y</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">內容不會裁切，溢出元素之外【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">hidden</span>
        <span class="t-flex5">溢出的內容會被裁切，且不可視</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">scroll</span>
        <span class="t-flex5">溢出的內容會被裁切，但元素會顯示滾動捲軸查看裁切的內容</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">auto</span>
        <span class="t-flex5">和 <em>scroll</em> 雷同，但只有當內容溢出時才會出現滾動捲軸</span>
    </div>    
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="YzKwJqX" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-overflow-y">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/YzKwJqX/">
    css-overflow-y</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.overflowY="hidden"</code></pre>
