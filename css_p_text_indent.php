...
<!-- start -->
<p><em>text-indent</em> 主要用來設定文本第一行的縮排。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>text-indent</em></h2>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">固定數字單位【預設值為 0】</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="dxePax" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-text-indent">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/dxePax/">
    css-text-indent</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.textIndent="1rem"</code></pre>
