...
<!-- start -->
<p><em>border-right</em> 可用來給元素左側添加邊框。<br><em>border-right</em> 是一行設置其所有屬性的方法，包含 <em>border-right-width</em>、<em>border-right-style</em> 與 <em>border-right-color</em>。</p>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        <span class="t-flex1">border-right-width</span>
        <span class="t-flex5">邊框的寬度</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">border-right-style</span>
        <span class="t-flex5">邊框的樣式</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">border-right-color</span>
...
<div class="code-area">
    ...
    border-right: width style color;      /* 順序可以變動 */
}</code></pre>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>border-right-width</em></h2>
<div class="t-form">
    <div class="t-head">
...
<h2 class="cssproperty"><em>border-right-style</em></h2>
<div class="t-form">
    <div class="t-head">
        <span class="t-flex1">Value</span>
        <span class="t-flex5">Description</span>
...
<h2 class="cssproperty"><em>border-right-color</em></h2>
<div class="t-form">
    <div class="t-head">
        <span class="t-flex1">Value</span>
        <span class="t-flex5">Description</span>
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="vYBLPgW" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-border-right">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/vYBLPgW/">
    css-border-right</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
<pre id="area03" class="code-text"><code class="js">object.style.borderRight="1px solid #000"

// border-right-width
object.style.borderRightWidth="1px"

// border-right-style
object.style.borderRightStyle="solid"

// border-right-color
object.style.borderRightColor="#000"
</code></pre>
