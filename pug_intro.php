...
<p>由範例可知 Pug 是一套可以將 HTML 大為簡化進而提升開發效率的模板引擎，既然說是模板引擎，意味著 Pug 可以將一些網頁內容（例如多個頁面的共同內容）獨立製作成模板，利用 Pug 的特定指令，讓其他頁面可以繼承或套用模板內容。除此之外，Pug 省略掉 HTML 標籤前後的嵌套符號（<em>&lt;&gt;</em>），標籤結束時也不需要結尾標籤，免去了漏寫結尾標籤導致網頁排版錯亂而產生的困擾。至於大量簡化程式碼結構的 Pug 有沒有比傳統 HTML 來的好讀，就像有些人喜歡 Sass 的簡潔，有些人仍喜歡保留嵌套符號的 SCSS 一樣，屬於見仁見智沒有標準答案的問題。</p>
<br>
