...
<!-- start -->
<p><em>border-top</em> 可用來給元素左側添加邊框。<br><em>border-top</em> 是一行設置其所有屬性的方法，包含 <em>border-top-width</em>、<em>border-top-style</em> 與 <em>border-top-color</em>。</p>
<div class="t-form">
    <div class="t-head">
    ...
    <div class="t-row">
        <span class="t-flex1">border-top-width</span>
        <span class="t-flex5">邊框的寬度</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">border-top-style</span>
        <span class="t-flex5">邊框的樣式</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">border-top-color</span>
...
<div class="code-area">
    ...
    border-top: width style color;      /* 順序可以變動 */
}</code></pre>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>border-top-width</em></h2>
<div class="t-form">
    <div class="t-head">
...
<h2 class="cssproperty"><em>border-top-style</em></h2>
<div class="t-form">
    <div class="t-head">
        <span class="t-flex1">Value</span>
        <span class="t-flex5">Description</span>
...
<h2 class="cssproperty"><em>border-top-color</em></h2>
<div class="t-form">
    <div class="t-head">
        <span class="t-flex1">Value</span>
        <span class="t-flex5">Description</span>
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="abodMQW" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-border-top">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/abodMQW/">
    css-border-top</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
<pre id="area03" class="code-text"><code class="js">object.style.borderTop="1px solid #000"

// border-top-width
object.style.borderTopWidth="1px"

// border-top-style
object.style.borderTopStyle="solid"

// border-top-color
object.style.borderTopColor="#000"
</code></pre>
