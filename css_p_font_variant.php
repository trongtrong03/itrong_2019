...
<!-- start -->
<p><em>font-variant</em> 可將文本的英文小寫字轉換為小寫尺寸的大寫字母字體。</p>
...
<!-- 屬性值 -->
<h2 class="cssproperty"><em>font-variant</em></h2>
<div class="t-form">
    <div class="t-head"> 
    ...
    <div class="t-row">
        ...
        <span class="t-flex5">正常【預設值】</span>
    </div>
    <div class="t-row">
        <span class="t-flex1">small-caps</span>
        <span class="t-flex5">將小寫字母轉換為大寫字母但仍保持小寫的尺寸大小</span>
    </div>
    <div class="t-row">
...
<h3 class="demo"></h3>
<code>
    <p class="codepen" data-height="480" data-theme-id="0" data-default-tab="css,result" data-user="itrong" data-slug-hash="ZgMMbg" style="height: 265px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="css-font-variant">
    <span>See the Pen <a href="https://codepen.io/itrong/pen/ZgMMbg/">
    css-font-variant</a> by Trong (<a href="https://codepen.io/itrong">@itrong</a>)
...
<h3 class="js"></h3>
<div class="code-area">
    <pre id="area03" class="code-text"><code class="js">object.style.fontVariant="small-caps"</code></pre>
